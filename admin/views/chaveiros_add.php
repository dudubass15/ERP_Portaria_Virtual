          ...
          <div class="row">
              <div class="form-group">
                  <div class="col-md-12">
                      ...
                      <input type="text" class="form-control" id="nome" name="nome" placeholder="---" required placeholder="" class="alert alert-danger" role="alert">
                 ...
                 <div class="col-md-4">
                  ...
                  <div class="botao-morador">
                    <button type="enviar" class="btn btn-primary btn btn-primary">Salvar</button>
                  </div>
                </div>
              </form>
            </div>
