      ...
      <div class="col-lg-4" style="float: right;">
        <form method="POST">
          <div class="input-group">
            <input type="text" name="pesquisar" class="form-control" placeholder="Nome do Condomínio ...">
        ...
        <table class="table table-hover table-condensed">
          <thead class="titulo-table">
            <tr>
              ...
              <th class="titulo-table">Síndico:</th>
          ...
          <tbody class="conteudo-table">
            <?php foreach($lista_condominio as $c): ?> 
              <tr class="info">
                <td style="padding-top: 30px"><?php echo $c['ramal']; ?></td>
                <td style="padding-top: 30px"><?php echo $c['nome']; ?></td>
                <td style="padding-top: 30px"><?php echo $c['sindico']; ?></td>
                ...
                <td>
                  <a href="<?php echo URL; ?>/condominio/edit/<?php echo $c['id']; ?>" class="btn btn-success" role="button" style="width: 100px;">Editar</a>
                  <a href="<?php echo URL; ?>/condominio/del/<?php echo $c['id']; ?>" class="btn btn-danger" role="button" style="width: 100px;">Deletar</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
