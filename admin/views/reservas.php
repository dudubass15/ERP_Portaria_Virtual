      ...
      <div class="col-lg-4" style="float: right;">
        <form method="POST">
          <div class="input-group">
            <input type="text" name="pesquisar" class="form-control" placeholder="Digite o nome ...">
        ...
        <table class="table table-hover table-condensed">
          <thead class="titulo-table">
            <tr>
              ...
              <th class="titulo-table">Responsaveis:</th>
              ...
              <th class="titulo-table">Convidados:</th>
              <th class="titulo-table">Ações:</th>
            </tr>
          </thead>
          <tbody class="conteudo-table">
            <?php foreach($lista_reservas as $c): ?>
              <tr class="info">
                <td style="padding-top: 30px"><?php echo $c['apartamento']; ?></td>
                <td style="padding-top: 30px"><?php echo $c['nome']; ?></td>
                <td style="padding-top: 30px"><?php echo $c['responsaveis']; ?></td>
                <td style="padding-top: 30px"><?php echo $c['condominio']; ?></td>
                <td style="padding-top: 30px"><?php echo $c['local']; ?></td>
                <td style="padding-top: 30px"><?php echo $c['data']; ?></td>
                <td style="padding-top: 30px"><?php echo $c['telefone']; ?></td>
                <td style="padding-top: 30px"><?php echo $c['convidados']; ?></td>
                <td>
                  <a href="<?php echo URL; ?>/reservas/edit/<?php echo $c['id']; ?>" class="btn btn-success" role="button" style="width: 100px;">Editar
                  </a>
                  <a href="<?php echo URL; ?>/reservas/del/<?php echo $c['id']; ?>" class="btn btn-danger" role="button" style="width: 100px;">Deletar
                  </a>
                </td>
              </tr>
            <?php endforeach; ?>
