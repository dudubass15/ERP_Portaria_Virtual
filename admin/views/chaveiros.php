      ...
      <!-- Termina barra de pesquisa -->
        ...
        <table class="table table-hover table-condensed">
          ...
          <tbody class="conteudo-table">
            <?php foreach($lista_chaveiros as $c): ?> 
              <tr class="info">
                ...
                <td>
                  <a href="<?php echo URL; ?>/chaveiros/edit/<?php echo $c['id']; ?>" class="btn btn-success" role="button" style="width: 100px;">Editar</a>
                  <a href="<?php echo URL; ?>/chaveiros/del/<?php echo $c['id']; ?>" class="btn btn-danger" role="button" style="width: 100px;">Deletar</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
